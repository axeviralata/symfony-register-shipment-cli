...
class CommandShipmentRegistrationValidatorTest extends KernelTestCase
{
     ...
     * @test
     */
    public function validateInputWithNoViolations(): void
    {
     ...
     * @test
     */
    public function validateInputNotJsonForOrderAsInput(): void
    {
        $inputMock = $this->createMock(InputInterface::class);
        // ups
        $inputMock->method('getOption')->willReturnMap([
     ...
     * @test
     */
    public function buildResponseArrayWrongParseOrNotArray(): void
    {
        ...
        $this->assertEquals(['invalidValue1: Message1', 'invalidValue2: Message2'],
            $violations,
            'Returned data is not matching input data');
    }
